// An allocator built on emscripten's malloc/calloc/realloc/free, with the
// same alignment guarantees as Odin's default heap allocator (needed for
// maps and SIMD to work).
